...
enum ResourceCatalog {
    ...
    static let capsuleBox = VesselRecipe(
        ...
        entity:EntityProfile(
            id:"capsule",
            geometry:TokenGeometry(referenceFrame:.init(x:212,y:104,width:100,height:293),
                                   displaySize:.init(width:38,height:111.34),
                                   pieces:[.capsule(frame:.init(x:218,y:114,width:86,height:274))]),
        ...
        skins:[SkinProfile(id:"capsule-red-green",entityID:"capsule",asset:"Capsule_Closed",
                           sourceSize:.init(width:512,height:512),
                           contentRect:.init(x:212,y:104,width:100,height:293))],
        policy:SimulationPolicy(
            gravity:.init(x:0,y:-2.4),capacity:10,initialCount:8,
